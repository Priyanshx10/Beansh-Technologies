...
const HomePage = () => {
  const services = [
    ...
    },
    {
      ...
      icon: <FaShoppingCart className="text-5xl text-purple-600 mb-4" />,
  ...
  const clients = [
    { name: "TechCorp", icon: <FaUser className="text-6xl text-blue-600" /> },
    { name: "InnovateTech", icon: <FaBriefcase className="text-6xl text-green-500" /> },
    { name: "FutureSystems", icon: <FaCogs className="text-6xl text-purple-600" /> },
    { name: "GlobalAI", icon: <FaRobot className="text-6xl text-red-500" /> },
    { name: "SmartSolutions", icon: <FaTools className="text-6xl text-yellow-500" /> },
  ]

  return (
    <div className="bg-gradient-to-b from-gray-100 to-white">
      {/* Hero Section */}
      <section className="py-32 text-center bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        ...
        <button className="bg-white text-blue-600 px-10 py-4 rounded-full text-2xl font-semibold hover:bg-blue-100 transition duration-300 transform hover:scale-105">
          Get Started
        </button>
      </section>
      ...
      <section className="py-24 container mx-auto px-6">
        <h2 className="text-6xl font-semibold mb-20 text-center text-blue-800">Our Services</h2>
      ...
      {/* Trusted By Section */}
      <section className="py-24 bg-gradient-to-r from-purple-100 to-blue-100 rounded-3xl mx-6">
        <h2 className="text-6xl font-semibold mb-20 text-center text-blue-800">Trusted By Industry Leaders</h2>
        <div className="flex flex-wrap justify-center items-center gap-20">
          {clients.map((client, index) => (
            <div key={index} className="text-center transform hover:scale-110 transition-transform duration-300">
              ...
              <p className="text-blue-800 font-semibold text-xl">{client.name}</p>
            </div>
          ))}
        </div>
        <div className="text-center mt-20">
          <a href="/case-studies" className="text-blue-600 hover:text-blue-800 font-semibold text-2xl inline-flex items-center transition-colors duration-300">
      ...
      {/* Testimonial */}
      <section className="py-32 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-3xl my-24 shadow-2xl mx-6">
        <div className="max-w-5xl mx-auto text-center px-8">
          <div className="mb-16 transform -translate-y-20">
            <div className="bg-white rounded-full p-8 inline-block shadow-xl">
              <FaRocket className="text-8xl text-blue-600" />
            </div>
          </div>
          <blockquote className="text-4xl font-light leading-relaxed mb-16 flex items-center">
            <FaQuoteLeft className="text-6xl text-blue-300 mr-6" />
            ...
            <FaQuoteRight className="text-6xl text-blue-300 ml-6" />
          </blockquote>
          <div className="flex items-center justify-center">
            ...
            <div className="text-left">
              <p className="font-bold text-3xl flex items-center">
                <FaUser className="mr-3 text-blue-300" /> Priyansh Yadav
              </p>
              <p className="text-2xl text-blue-200 flex items-center mt-2">
                <FaBriefcase className="mr-3 text-blue-300" /> CEO of Beansh AI Technologies
              </p>
            </div>
          </div>
        </div>
