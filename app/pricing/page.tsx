...
const PricingPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-16 bg-gray-100">
      <h1 className="text-5xl font-bold mb-12 text-center text-blue-900">Our Services and Pricing</h1>
              ...
              <div className="space-y-4">
                {service.plans.map((plan, planIndex) => (
                  <div key={planIndex} className="border-t pt-4">
                    ...
                    <p className="text-blue-700 font-bold mt-2">{plan.price}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="mt-16 text-center">
        ...
        <a 
          href="/contact"
          className="bg-blue-700 text-white px-8 py-4 rounded-full hover:bg-blue-800 transition-colors duration-300 text-lg font-semibold shadow-lg hover:shadow-xl"
        >
